...
public class ViewCustomerReturn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice No", "Item Code", "Item Name", "QTY", "Return Date", "Term", "Condition"
            }
        ));
...
//            cr.add(Restrictions.between("serviceChargeDate", TxtStartDatefro.getText(), TxtStartDateTo.getText()));
//            
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCustomerReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

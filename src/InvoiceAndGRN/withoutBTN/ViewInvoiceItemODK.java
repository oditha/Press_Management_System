...
//        SetMaximized();
    ...
    private void loadData() {
        ...
        try {
            ...
            cr.add(Restrictions.eq("idInvoice", Integer.parseInt(new ViewInvoiceODKNEW().InvoiceNO)));
            ...
            for (Invoice invoice : list) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next.getIsDelete().equals("Active")) {
                        ...
                        v.add(next.getItems().getItemCatagory().getCatagoryName());
                        v.add(next.getItems().getItemsSellingPrice());
                        v.add(next.getQty());

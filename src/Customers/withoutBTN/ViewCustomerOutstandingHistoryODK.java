 ...
 * @author arshak
 */
public class ViewCustomerOutstandingHistoryODK extends javax.swing.JFrame {

    /**
     * Creates new form OutstandingHistory
     */
    public ViewCustomerOutstandingHistoryODK() {
        initComponents();
        tableAlign();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String path = sf.getAbsolutePath();
        path = path.replace('\\', '/');
            ...
            Logger.getLogger(ViewCustomerOutstandingHistoryODK.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCustomerOutstandingHistoryODK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewCustomerOutstandingHistoryODK().setVisible(true);
            }
        });
    }

    ...
    private void txtGRNNoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtGRNNoKeyReleased
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                comboItem.addItem(next.getItems().getItemsCode() + " - " + next.getItems().getItemName());
...
//                    System.out.println(getSupID);
                ...
                createCriteria1.add(Restrictions.eq("itemsCode", s));
                ...
                createCriteria2.createAlias("items", "i");
